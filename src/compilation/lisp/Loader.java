...
static final int max_terminaux = 5;
static final int max_regles = 7;
...
"Prog"  , "Suite_Prog" , "Sexpr" ,
"Liste" , "Suite_Liste" , "Atome" , "Production"};

static final String nomfich_TABLE = "tab_lisp.dat";
...
static void charge_table()
{
    ...
    try {
    dos = new DataOutputStream(new FileOutputStream("lisp.log"));
